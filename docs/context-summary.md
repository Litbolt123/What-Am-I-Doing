...
- **2026-05-12** — **Ship v1.1.4:** [`Directory.Build.props`](Directory.Build.props) / [`app.manifest`](src/WhatAmIDoing/app.manifest) / Inno fallback → **1.1.4**; [`docs/RELEASE_BODY.md`](docs/RELEASE_BODY.md) — GitHub **paginated release scan** + **Settings**-first update UX. Tag **`v1.1.4`** when ready → Windows installer workflow. User plans **1.1.5** tag after sibling installs **1.1.4** for another updater pass.
